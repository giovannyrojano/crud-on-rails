...
class LibrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create libro" do
    assert_difference('Libro.count') do
      post libros_url, params: { libro: { anyo: @libro.anyo, autor: @libro.autor, titulo: @libro.titulo } }
    end
  ...
  test "should update libro" do
    patch libro_url(@libro), params: { libro: { anyo: @libro.anyo, autor: @libro.autor, titulo: @libro.titulo } }
