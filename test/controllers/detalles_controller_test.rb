...
class DetallesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detalle" do
    assert_difference('Detalle.count') do
      post detalles_url, params: { detalle: { Prestamo_id: @detalle.Prestamo_id, cantidad: @detalle.cantidad, libro_id: @detalle.libro_id } }
    end
  ...
  test "should update detalle" do
    patch detalle_url(@detalle), params: { detalle: { Prestamo_id: @detalle.Prestamo_id, cantidad: @detalle.cantidad, libro_id: @detalle.libro_id } }
