...
class PrestamosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prestamo" do
    assert_difference('Prestamo.count') do
      post prestamos_url, params: { prestamo: { Usuario_id: @prestamo.Usuario_id, estado: @prestamo.estado, fecha: @prestamo.fecha } }
    end
  ...
  test "should update prestamo" do
    patch prestamo_url(@prestamo), params: { prestamo: { Usuario_id: @prestamo.Usuario_id, estado: @prestamo.estado, fecha: @prestamo.fecha } }
