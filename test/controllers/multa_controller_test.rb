...
class MultaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create multum" do
    assert_difference('Multum.count') do
      post multa_url, params: { multum: { Prestamo_id: @multum.Prestamo_id, estado: @multum.estado, fecha: @multum.fecha, valor: @multum.valor } }
    end
  ...
  test "should update multum" do
    patch multum_url(@multum), params: { multum: { Prestamo_id: @multum.Prestamo_id, estado: @multum.estado, fecha: @multum.fecha, valor: @multum.valor } }
